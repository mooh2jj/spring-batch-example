package com.example.spring.batch.helloprac.job;

import com.example.spring.batch.helloprac.job.vaildator.LocalDateParameterValidator;
...
public class AdvancedJobConfig {
    ...
    public Tasklet advancedTasklet(@Value("#{jobParameters['targetDate']}") String targetDate) {
        return ((contribution, chunkContext) -> {
            ...
            // executionDate -> 로직 수행
            log.info("[advancedTasklet] exceuted advancedTasklet");
